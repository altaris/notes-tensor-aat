...
Let $\catAA$ be the category of algebraic theories and finite product preserving functors that are identity on objects, i.e. a morphism $F : \theory{T} \longrightarrow \theory{U}$ is a product preserving functor such that the follwing diagram commutes : \trianglediagramarrows{c->}{c->}{}
